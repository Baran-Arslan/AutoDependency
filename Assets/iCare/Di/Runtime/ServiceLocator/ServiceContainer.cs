...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("iCare.Di.Tests")]
    ...
    public sealed class ServiceContainer {
        ...
        static void ValidateKey(int key) {
            if (key is < 1000 and > -1000)
                throw new InvalidOperationException("Service key is too small to be valid! Did you convert it to hash correctly?".Highlight());
        }
