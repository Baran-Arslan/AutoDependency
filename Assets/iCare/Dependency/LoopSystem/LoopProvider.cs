...
namespace iCare
{
    [Service(true, typeof(ICoroutineManager))]
    internal sealed class LoopProvider : MonoBehaviour, ICoroutineManager
    {
        ...
        void InternalRegister<T>(T listener, ref T[] listeners, ref HashSet<T> listenerSet, ref int listenerCount)
            where T : class
        {
        ...
        void InternalUnregister<T>(T listener, ref T[] listeners, ref HashSet<T> listenerSet, ref int listenerCount)
            where T : class
        {
